...
set IPName      "idwt"
set Version     "1.0"
set DisplayName "Idwt"
set Revision    "1811151625"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 imageIn0 W 0x0 "Data signal of imageIn0" {{0 32 imageIn0 W 0 "Bit 31 to 0 Data signal of imageIn0"}}} {0x18 imageIn1 W 0x0 "Data signal of imageIn1" {{0 32 imageIn1 W 0 "Bit 31 to 0 Data signal of imageIn1"}}} {0x20 imageIn2 W 0x0 "Data signal of imageIn2" {{0 32 imageIn2 W 0 "Bit 31 to 0 Data signal of imageIn2"}}} {0x28 imageIn3 W 0x0 "Data signal of imageIn3" {{0 32 imageIn3 W 0 "Bit 31 to 0 Data signal of imageIn3"}}} {0x30 imageOut W 0x0 "Data signal of imageOut" {{0 32 imageOut W 0 "Bit 31 to 0 Data signal of imageOut"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS m_axi_IMAGE_IN0 m_axi_IMAGE_IN1 m_axi_IMAGE_IN2 m_axi_IMAGE_IN3 m_axi_IMAGE_OUT"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_IMAGE_IN0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMAGE_IN0"
        data_width "32"
        param_prefix "C_M_AXI_IMAGE_IN0"
    ...
    m_axi_IMAGE_IN1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMAGE_IN1"
        data_width "32"
        param_prefix "C_M_AXI_IMAGE_IN1"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_IMAGE_IN2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMAGE_IN2"
        data_width "32"
        param_prefix "C_M_AXI_IMAGE_IN2"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_IMAGE_IN3 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMAGE_IN3"
        data_width "32"
        param_prefix "C_M_AXI_IMAGE_IN3"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 5.000000 machine 64 combinational 0 latency 1115012 II x}
...
set enable_xo_gen 0
set kernel_files {/home/vivado/Vivado-Projects/HLS_phantom_idwt/idwt.cpp}
if {$enable_xo_gen} {
